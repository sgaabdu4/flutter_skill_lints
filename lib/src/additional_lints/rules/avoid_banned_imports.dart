...
final class AvoidBannedImports extends AnalysisRule {
  static const LintCode code = LintCode(
    ...
    "Avoid importing banned package '{0}'.",
    correctionMessage: 'Remove the import or move the dependency behind an approved boundary.',
  );
  ...
  AvoidBannedImports()
    : super(
        ...
        description: 'Warns when app source imports banned architecture packages.',
      );
