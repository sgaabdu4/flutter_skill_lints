...
- #36: a whole `AsyncValue` passed into an app widget stays clean, because it is a sealed union with fewer than two public abstract getters. Probe: probe_b_skill_controls_page.dart:105.
